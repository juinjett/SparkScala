...
object MovieSimilarities1MLocal {
  ...
  type MovieIDRating = (Int, Double)
  type UserIDRatingPair = (Int, (MovieIDRating, MovieIDRating))
  def createPairs(usersRatings:UserIDRatingPair) = {
    val MovieIDRating1 = usersRatings._2._1
    val MovieIDRating2 = usersRatings._2._2
    
    val movie1 = MovieIDRating1._1
    val rating1 = MovieIDRating1._2
    val movie2 = MovieIDRating2._1
    val rating2 = MovieIDRating2._2
    
    ((movie1, movie2), (rating1, rating2))
  }
  
  def filterDuplicates(usersRatings:UserIDRatingPair):Boolean = {
    val MovieIDRating1 = usersRatings._2._1
    val MovieIDRating2 = usersRatings._2._2
...
//    conf.setAppName("MovieSimilarities1M")
    val sc = new SparkContext("local[*]", "MovieSimilarities1MLocal")
    ...
    val moviePairs = uniqueJoinedRatings.map(createPairs).partitionBy(new HashPartitioner(100))
