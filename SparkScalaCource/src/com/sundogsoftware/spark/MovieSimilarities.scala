...
object MovieSimilarities {
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    var movieNames:Map[Int, String] = Map()
     ...
     // change file path for different data sets
//     val filePath = "../ml-100k/u.item"
     val filePath = "../ml-1m/movies.dat"
  ...
  def main(args: Array[String]) {
    ...
    // change file path for different data sets
//    val filePath = "../ml-100k/u.data"
    val filePath = "../ml-1m/ratings.dat"
